        ...
        <main class="content__main">
          ...
          <form class="form" class="" action="index.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form__row">
              ...
              <input class="form__input
              <?php
                  if (isset($array["reg_formerror"]["password"])) {
                      print ('form__input--error');
                  }
              ?>
              "
              ...
              <?php
                  if (isset($array["reg_formerror"]["email"])) {
                      print ('<p class="form__message">Введите пароль</p>');
                  }
              ?>
            </div>
            ...
            <div class="form__row">
              ...
              <input class="form__input
              <?php
                  if (isset($array["reg_formerror"]["name"])) {
                      print ('form__input--error');
                  }
              ?>
              "
              ...
              <?php
                  if (isset($array["reg_formerror"]["name"])) {
                      print ('<p class="form__message">Введите имя</p>');
                  }
              ?>
            </div>
            ...
            <div class="form__row form__row--controls">
              <?php
                  if (isset($array["reg_formerror"])) {
                      print ('<p class="error-massage">Пожалуйста, исправьте ошибки в форме</p>');
                  }
              ?>

...
>
  ...
  <div class="modal"
  <?php
    if (empty($_GET["login"])) {/*проверка пустой ли $_GET["login"]*/
  ...
  >
    ...
    <form class="form" class="" action="index.php" method="post">
      <div class="form__row">
        ...
        <?php if ((!isset($_SESSION['user'])) and (isset($_POST["email"]))): ?> <!--проверяем наличие данных-->
      ...
      <div class="form__row">
        ...
        <input class="form__input
        <?php
            if (isset($array["usererror"]["password"])) {
                print ("form__input--error");
            }
        ?>
